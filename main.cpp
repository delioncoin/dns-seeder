...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Delion-seeder\n"
...
static const string mainnet_seeds[] = {"1.delion.online", "2.delion.online", "3.delion.online", "4.delion.online", "5.delion.online", "6.delion.online", "7.delion.online", "8.delion.online", "9.delion.online", "10.delion.online",  ""};
static const string testnet_seeds[] = {"test.delion.xyz", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("94.177.215.165", 15858), true);
  }
  do {
